...
normal_rule ([
      ...
      {| clause_rel := "Check"; clause_args := [(var_expr "a"); (var_expr "_anon0"); (var_expr "c"); (var_expr "d"); (var_expr "_anon1"); (var_expr "_anon2")] |};
      {| clause_rel := "In"; clause_args := [(var_expr "a"); (var_expr "_anon3"); (var_expr "c"); (var_expr "d"); (var_expr "_anon4"); (var_expr "_anon5"); (var_expr "i")] |}
    ]).
...
normal_rule ([
      ...
      {| clause_rel := "Check"; clause_args := [(var_expr "a"); (var_expr "b"); (var_expr "_anon0"); (var_expr "d"); (var_expr "_anon1"); (var_expr "_anon2")] |};
      {| clause_rel := "In"; clause_args := [(var_expr "a"); (var_expr "b"); (var_expr "_anon3"); (var_expr "d"); (var_expr "_anon4"); (var_expr "_anon5"); (var_expr "i")] |}
    ]).
...
normal_rule ([
      ...
      {| clause_rel := "Check"; clause_args := [(var_expr "_anon0"); (var_expr "b"); (var_expr "_anon1"); (var_expr "_anon2"); (var_expr "_anon3"); (var_expr "_anon4")] |};
      {| clause_rel := "In"; clause_args := [(var_expr "_anon5"); (var_expr "b"); (var_expr "_anon6"); (var_expr "_anon7"); (var_expr "_anon8"); (var_expr "_anon9"); (var_expr "i")] |}
    ]).
