...
normal_rule ([
      ...
      {| clause_rel := "Check"; clause_args := [(var_expr "a"); (var_expr "b"); (var_expr "c"); (var_expr "_anon0"); (var_expr "e"); (var_expr "_anon1")] |};
      {| clause_rel := "In"; clause_args := [(var_expr "a"); (var_expr "b"); (var_expr "c"); (var_expr "_anon2"); (var_expr "e"); (var_expr "_anon3"); (var_expr "i")] |}
    ]).
...
normal_rule ([
      ...
      {| clause_rel := "Check"; clause_args := [(var_expr "_anon0"); (var_expr "b"); (var_expr "_anon1"); (var_expr "d"); (var_expr "_anon2"); (var_expr "f")] |};
      {| clause_rel := "In"; clause_args := [(var_expr "_anon3"); (var_expr "b"); (var_expr "_anon4"); (var_expr "d"); (var_expr "_anon5"); (var_expr "f"); (var_expr "i")] |}
    ]).
...
normal_rule ([
      ...
      {| clause_rel := "Check"; clause_args := [(var_expr "a"); (var_expr "b"); (var_expr "_anon0"); (var_expr "d"); (var_expr "_anon1"); (var_expr "f")] |};
      {| clause_rel := "In"; clause_args := [(var_expr "a"); (var_expr "b"); (var_expr "_anon2"); (var_expr "d"); (var_expr "_anon3"); (var_expr "f"); (var_expr "i")] |}
    ]).
