...
Datalog.normal_rule ([
      {| Datalog.clause_rel := "Triangle"; Datalog.clause_args := [(var_expr "x"); (var_expr "y"); (var_expr "z")] |}
    ]) ([
      {| Datalog.clause_rel := "R"; Datalog.clause_args := [(var_expr "x"); (var_expr "y")] |};
      {| Datalog.clause_rel := "S"; Datalog.clause_args := [(var_expr "y"); (var_expr "z")] |};
      {| Datalog.clause_rel := "T"; Datalog.clause_args := [(var_expr "z"); (var_expr "x")] |}
    ]).
