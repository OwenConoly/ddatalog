...
From DatalogRocq Require Import Examples.SouffleGeneratedRocq.Po3 DistributedDatalogToHardwareCompiler StringDatalogParams StringGridCompiler.
...
Definition compiled_po3 := compile_program program_to_compile layout (all_io_locations program_to_compile layout topo_dims) (all_io_locations program_to_compile layout topo_dims) topo_dims (grid_fuel topo_dims).
