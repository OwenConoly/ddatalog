...
From DatalogRocq Require Import Examples.SouffleGeneratedRocq.X9 DistributedDatalogToHardwareCompiler StringDatalogParams StringGridCompiler.
...
Definition compiled_x9 := compile_program program_to_compile layout (all_io_locations program_to_compile layout topo_dims) (all_io_locations program_to_compile layout topo_dims) topo_dims (grid_fuel topo_dims).
