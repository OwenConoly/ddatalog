...
From DatalogRocq Require Import Examples.SouffleGeneratedRocq.Trans DistributedDatalogToHardwareCompiler StringDatalogParams StringGridCompiler.
...
Definition compiled_trans := compile_program program_to_compile layout (all_io_locations program_to_compile layout topo_dims) (all_io_locations program_to_compile layout topo_dims) topo_dims (grid_fuel topo_dims).

Eval vm_compute in compiled_trans.