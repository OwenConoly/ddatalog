...
From DatalogRocq Require Import Examples.SouffleGeneratedRocq.Ranpo DistributedDatalogToHardwareCompiler StringDatalogParams StringGridCompiler.
...
Definition compiled_ranpo := compile_program program_to_compile layout (all_io_locations program_to_compile layout topo_dims) (all_io_locations program_to_compile layout topo_dims) topo_dims (grid_fuel topo_dims).

Eval vm_compute in compiled_ranpo.